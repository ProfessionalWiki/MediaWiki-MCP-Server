...
export const smwListProperties: Tool<typeof inputSchema> = {
	...
	description:
		'Lists Semantic MediaWiki properties on the active wiki. Enabled only when the wiki has SMW installed. Each entry has the property name, a copy-paste `[[name::value]]` template for smw-query, and — when SMW exposes them — a description and usage count. Wikis often have hundreds of properties; supply search to narrow. Up to 200 per call; paginate with continueFrom.',
	inputSchema,
	annotations: {
