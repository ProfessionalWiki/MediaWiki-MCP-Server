...
| `smw-ask` | Run a Semantic MediaWiki `#ask` query. Enabled only when the wiki has SMW installed. | - |
| `smw-list-properties` | List Semantic MediaWiki properties with copy-paste templates for `smw-ask`. Enabled only when the wiki has SMW installed. | - |
